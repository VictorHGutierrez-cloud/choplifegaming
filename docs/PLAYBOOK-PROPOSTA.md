...
- [ ] Prompts colados: `PROMPT-CURSOR-7-SLIDES.md` + `PROMPT-CURSOR-HR-JOURNEY.md`
- [ ] `src/data/journeySteps.ts` adaptado (5 passos + next steps)
- [ ] `public/journey/` — imagens do cliente (ou placeholders substituídos)
- [ ] `npm run build` sem erros
- [ ] Zero referências ao cliente template nos slides e journey
- [ ] Repo GitHub criado com nome = `repoName`
- [ ] GitHub Pages → Source: **GitHub Actions**
- [ ] Links enviados: `/` · `/proposta` · `/jornada`
