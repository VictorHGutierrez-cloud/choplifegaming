...
echo "  3. Paste prompts from $DEST/docs/PROMPT-CURSOR-7-SLIDES.md"
echo "     and $DEST/docs/PROMPT-CURSOR-HR-JOURNEY.md"
echo "  4. cd $DEST && npm ci && npm run dev"
echo "  5. Open http://localhost:8080/${SLUG}/ and /${SLUG}/jornada"
